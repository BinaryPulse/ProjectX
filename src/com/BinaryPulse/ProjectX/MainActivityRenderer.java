...
import com.BinaryPulse.ProjectX.ErrorHandler.ErrorType;
...
public class MainActivityRenderer implements GLSurfaceView.Renderer {
	 ...
	 */
	public MainActivityRenderer(final MainActivity MainActivity, ErrorHandler errorHandler) {
	...
	public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
		...
		// Load the texture
		texture_head = TextureHelper.loadTexture(MainActivity,R.drawable.queen);		// 
		...
		texture_topbody = TextureHelper.loadTexture(MainActivity,R.drawable.torso);		// 
		GLES20.glGenerateMipmap(GLES20.GL_TEXTURE_2D);			
		...
		texture_legwings = TextureHelper.loadTexture(MainActivity,R.drawable.legswings);		// 
		GLES20.glGenerateMipmap(GLES20.GL_TEXTURE_2D);			
		...
		texture_eye_diff = TextureHelper.loadTexture(MainActivity,R.drawable.eye_diff);		// 
		GLES20.glGenerateMipmap(GLES20.GL_TEXTURE_2D);			
		...
		texture_eye_emis = TextureHelper.loadTexture(MainActivity,R.drawable.eye_emis);		// 
		GLES20.glGenerateMipmap(GLES20.GL_TEXTURE_2D);			
	...
	{	
	    ...
	    Button1=new Button(MainActivity,0,10+10.0f*UniformScaleX,40.0f*UniformScaleY,1.0f,(float)200.0f*UniformScaleX,(float)60.0f*UniformScaleY,3.0f,UniformScaleX);
	   Button1.SetDispWiodowSize(windowWidth,windowHeight);	
	   Button1.AddCaption("START");
	   	    
	    Button2=new Button(MainActivity,0,10+240.0f*UniformScaleX,40.0f*UniformScaleY,1.0f,(float)200.0f*UniformScaleX,(float)60.0f*UniformScaleY,3.0f,UniformScaleX);
	   ...
	   DropDownList2 = new DropDownList(MainActivity,0,10+15.0f*UniformScaleX,480.0f*UniformScaleY,1.0f,(float)300.0f*UniformScaleX,(float)60.0f*UniformScaleY,3.0f,UniformScaleX);
	   DropDownList2.SetDisplayList(5, DropDownStrings);
	   DropDownList2.SetDispWiodowSize(windowWidth,windowHeight);	

	   DropDownList3 = new DropDownList(MainActivity,0,10+15.0f*UniformScaleX,380.0f*UniformScaleY,1.0f,(float)300.0f*UniformScaleX,(float)60.0f*UniformScaleY,3.0f,UniformScaleX);
