...
public class SlideBar extends UIControlUnit {
...
************************************************************************************/
 ...
 public void InitGLDataForBackPanel()
 {
	...
	float 	vertexBuffer[] = {
			...
			m_DragBoxOffSetX+ m_BorderWidth+m_DragBoxHeight, m_DragBoxOffSetY+m_DragBoxHeight+4*m_BorderWidth,0.0f,  
			0.6f, 0.6f, 0.9f, 0.6f,		
			m_DragBoxOffSetX+ m_BorderWidth, m_DragBoxOffSetY+m_DragBoxHeight+4*m_BorderWidth,0.0f,  
			0.6f, 0.6f, 0.9f, 0.6f,				
			
			m_DragBoxOffSetX+ m_BorderWidth+m_DragBoxHeight, m_DragBoxOffSetY+m_DragBoxHeight*0.3f+4*m_BorderWidth,0.0f,  
			0, 0.0f, 0.6f, 0.6f,		
			m_DragBoxOffSetX+ m_BorderWidth, m_DragBoxOffSetY+m_DragBoxHeight*0.3f+4*m_BorderWidth,0.0f,  
			0, 0.0f, 0.6f, 0.6f, 
			
			m_DragBoxOffSetX+ m_BorderWidth+m_DragBoxHeight, m_DragBoxOffSetY+m_DragBoxHeight*0.7f+4*m_BorderWidth,0.0f,  
			0, 0.0f, 0.6f, 0.6f,		
			m_DragBoxOffSetX+ m_BorderWidth, m_DragBoxOffSetY+m_DragBoxHeight*0.7f+4*m_BorderWidth,0.0f,  
			0, 0.0f, 0.6f, 0.6f, 
			
			m_DragBoxOffSetX+ m_BorderWidth+m_DragBoxHeight, m_DragBoxOffSetY+4*m_BorderWidth ,0.0f,      
			0.6f, 0.6f, 0.9f,  0.6f,
			m_DragBoxOffSetX+ m_BorderWidth, m_DragBoxOffSetY+4*m_BorderWidth ,0.0f,
			0.6f, 0.6f, 0.9f,  0.6f,	
...
子函数描述：UIControlUnit(), 初始化
************************************************************************************/
SlideBar(Context context,int ControlType,float OffSetX,float OffSetY,float Scale,float BorderWith){
...
************************************************************************************/
 ...
 public SlideBar(Context context,int ControlType,float OffSetX,float OffSetY,float Scale,float Width,float Height,float BorderWith)
{
	super(context,ControlType, OffSetX, OffSetY, Scale, BorderWith);	  
